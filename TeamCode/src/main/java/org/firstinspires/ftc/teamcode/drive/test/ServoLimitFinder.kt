...
class ServoLimitFinder: OpMode() {
    ...
    override fun init() {
        ...
        servo = hardwareMap.get(ServoImplEx::class.java, DeviceIDs.DEPOSIT)
    ...
    object ServoPositions {
        @JvmField var min = VerticalConstants.DepositPositions.IN
        @JvmField var mid = VerticalConstants.DepositPositions.MID
        @JvmField var max = VerticalConstants.DepositPositions.OUT
    }
}
