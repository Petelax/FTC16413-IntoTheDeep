...
class FiveSpecimenAuto : OpMode() {
    ...
    private val pickupFirst = PurePursuitController.waypointsToPath(listOf(
        CurvePoint(Pose2d(138.9, 58.0, Rotation2d.fromDegrees(-90.5)), 1.0, 1.0, 6.0),
        CurvePoint(Pose2d(138.9, 50.0, Rotation2d.fromDegrees(-90.5)), 1.0, 1.0, 6.0),
        CurvePoint(Pose2d(138.9, 40.0, Rotation2d.fromDegrees(-90.5)), 1.0, 1.0, 6.0, 0.1, 0.9),
        CurvePoint(Pose2d(138.9, 24.0, Rotation2d.fromDegrees(-90.5)), 0.85, 0.1, 6.0, 0.1, 0.9),
        CurvePoint(Pose2d(138.9, 20.5, Rotation2d.fromDegrees(-90.5)), 0.45, 0.1, 6.0, 0.1, 0.9),
        CurvePoint(Pose2d(138.9, 16.5, Rotation2d.fromDegrees(-90.5)), 0.35, 0.1, 6.0, 0.1, 0.9),
        CurvePoint(Pose2d(138.9, 0.0, Rotation2d.fromDegrees(-90.5)), 0.20, 0.1, 6.0, 0.05, 0.95),
    ...
    private val placeFirst = PurePursuitController.waypointsToPath(listOf(
        CurvePoint(Pose2d(137.2, 16.0, Rotation2d.fromDegrees(-90.0)), 1.0, 1.0, 6.0),
    ...
    private val park = PurePursuitController.waypointsToPath(listOf(
        ...
        CurvePoint(Pose2d(110.0, 12.0, Rotation2d.fromDegrees(-90.0)), 1.0, 1.0, 6.0),
    ), kSmooth = 0.95, kPID=0.9, kFF=0.1, kFollowDistance = 8.0, kCurvature = 0.075)
    ...
    val auto = Sequential(
        ...
        Timeout(
            Sequential(
                SwerveDrivetrain.bnvp2p(Pose2d(122.0, 55.0, Rotation2d.fromDegrees(-90.0)), 2.0, DrivebaseConstants.noVelocity.copy(TranslationPositionTolerance = 2.0, RotationPositionTolerance = 0.1)),
                SwerveDrivetrain.bnvp2p(Pose2d(130.0, 55.0, Rotation2d.fromDegrees(-90.0)), 2.0, DrivebaseConstants.noVelocity.copy(RotationPositionTolerance = 0.1)),
                SwerveDrivetrain.bnvp2p(Pose2d(130.0, 12.0, Rotation2d.fromDegrees(-90.0)), 2.0, DrivebaseConstants.noVelocity.copy(TranslationPositionTolerance = 2.0, RotationPositionTolerance = 0.1)),
        ...
        Race( null,
            ...
            Timeout(PurePursuitController.followPathCommand(pickupFirst, constants=DrivebaseConstants.noVelocity), 2.0),
        ),
