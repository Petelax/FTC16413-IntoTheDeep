...
class FiveSpecimenAutoV2 : OpMode() {
    ...
    private val first = PurePursuitController.waypointsToPath(listOf(
        ...
        CurvePoint(Pose2d(78.0, 33.0, Rotation2d.fromDegrees(90.0)), 0.9, 1.0, 6.0),
    ...
    private val pickupFourth = PurePursuitController.waypointsToPath(listOf(
        ...
        CurvePoint(Pose2d(69.0, 26.5, Rotation2d.fromDegrees(90.0)), 1.0, 1.0, 5.0),
        CurvePoint(Pose2d(85.0, 26.5, Rotation2d.fromDegrees(90.0)), 1.0, 1.0, 5.0),
        CurvePoint(Pose2d(95.0, 26.5, Rotation2d.fromDegrees(-70.0)), 1.0, 1.0, 6.0),
        CurvePoint(Pose2d(108.0, 26.5, Rotation2d.fromDegrees(-90.0)), 1.0, 1.0, 6.0),
    ...
    val auto = Sequential(
        ...
        Timeout(
            Sequential(
                ...
                SwerveDrivetrain.bnvp2p(Pose2d(137.6, 55.0, Rotation2d.fromDegrees(-91.0)), 1.0, DrivebaseConstants.noVelocity.copy(TranslationPositionTolerance = 0.4, RotationPositionTolerance = 0.03)),
