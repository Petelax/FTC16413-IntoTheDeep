...
class PurePursuitControllerTest {
    ...
    fun testGetFollowPathPoint() {
        val actual = pp.getFollowPointPath(path, Pose2d(0.0, 0.0, Rotation2d()), 3.0, 0.0)
    ...
    @Test
    fun `mid first line`() {
        val actual = pp.getFollowPointPath(path, Pose2d(12.0, 0.0, Rotation2d()), 3.0, 0.0)
    ...
    @Test
    fun `corner`() {
        val actual = pp.getFollowPointPath(path, Pose2d(48.0, 0.0, Rotation2d()), 3.0, 1.0)
    ...
    @Test
    fun `mid second line`() {
        val actual = pp.getFollowPointPath(path, Pose2d(48.0, 12.0, Rotation2d()), 3.0, 1.0)
    ...
    fun `right before second corner`() {
        val actual = pp.getFollowPointPath(path, Pose2d(48.0, 45.0, Rotation2d()), 3.0, 1.0)
    ...
    @Test
    fun `second corner`() {
        val previous = pp.getFollowPointPath(path, Pose2d(48.0, 45.0, Rotation2d()), 3.0, 1.0)
        //println("index: " + previous.second)
        //println("x: " + previous.first.pose.x)
        //println("y: " + previous.first.pose.y)

        val actual = pp.getFollowPointPath(path, Pose2d(48.0, 48.0, Rotation2d()), 3.0, previous.second)
    ...
    fun `just after second corner`() {
        val previous = pp.getFollowPointPath(path, Pose2d(48.0, 48.0, Rotation2d()), 3.0, 2.0)

        val actual = pp.getFollowPointPath(path, Pose2d(49.0, 48.0, Rotation2d()), 3.0, previous.second)
